...
function Filtrar() {
    ...
    const ruta = `/Denuncia/InvolucradosCE?idDenuncia=${denuncia}&nombre=${Nombre}&idSede=${sede}&idDepartamento=${departamento}`;
    window.location.assign(ruta);
}

$('#btnGuardarInvolucradosCE').click(function (e) {
    e.preventDefault();
    const url = BASE_PATH + 'Denuncia/GuardarInvolucradosCE';
    let datosFormulario = {
        IdDenuncia: $("#IdDenuncia").val(),
    }
    var form = $('#frmInvolucrado');
    var token = $('input[name="__RequestVerificationToken"]', form).val();
    var checkSeleccionado = false;
    let usuarios = [];

    $("#divInvolucradoCE input:checked").each(function (i, v) {
