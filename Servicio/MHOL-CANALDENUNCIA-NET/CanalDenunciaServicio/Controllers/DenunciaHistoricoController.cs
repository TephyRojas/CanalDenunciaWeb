using CanalDenunciaServicio.Data.Package.DenunciaHistoricoPkg;
...
{
    public class DenunciaHistoricoController : ApiController
    {
        DenunciaHistoricoService denunciaHistoricoService = new DenunciaHistoricoService();
        Util util = new Util();
        // POST: api/DenunciaHistorico/PostDenunciaHistorico
        /// <summary>
        /// Insertar Datos
        /// </summary>
        /// <remarks>
        /// Metodo para insertar datos en la tabla Denuncia Historico
        /// </remarks>
        /// <response code="401">Unauthorized. No se ha indicado o es incorrecto el Token JWT de acceso.</response>
        /// <response code="200">OK. Obtener todos los datos.</response>
        /// <response code="400">BadRequest. No se ha creado el objeto en la BD. Formato del objeto incorrecto.</response>
        [HttpPost]
        public HttpResponseMessage PostDenunciaHistorico(DenunciaHistoricoInputDto entity)
        {
            try
            {
                ...
                if (validaToken != null)
                {
                    ...
                    {
                        var result = denunciaHistoricoService.Insert(util.Conn, entity);
                        if (result > 0)
                        {
