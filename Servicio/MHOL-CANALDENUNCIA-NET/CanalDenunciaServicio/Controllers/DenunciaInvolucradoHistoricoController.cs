using CanalDenunciaServicio.Data.Package.DenunciaInvolucradoHistoricoPkg;
...
{
    public class DenunciaInvolucradoHistoricoController : ApiController
    {
        Util util = new Util();
        DenunciaInvolucradoHistoricoService denunciaInvolucradoHistoricoService = new DenunciaInvolucradoHistoricoService();

        // POST: api/DenunciaInvolucradoHistorico/PostDenunciaInvolucradoHistorico
        /// <summary>
        /// Insertar Datos
        /// </summary>
        /// <remarks>
        /// Metodo para insertar datos en la tabla Denuncia Involucrado Historico
        /// </remarks>
        /// <response code="401">Unauthorized. No se ha indicado o es incorrecto el Token JWT de acceso.</response>
        /// <response code="200">OK. Obtener todos los datos.</response>
        /// <response code="400">BadRequest. No se ha creado el objeto en la BD. Formato del objeto incorrecto.</response>
        [HttpPost]
        public HttpResponseMessage PostDenunciaInvolucradoHistorico(DenunciaInvolucradoHistoricoInputDto entity)
        {
            try
            {
                ...
                if (validaToken != null)
                {
                    ...
                    {
                        var result = denunciaInvolucradoHistoricoService.Insert(util.Conn, entity);
                        if (result > 0)
                        {
